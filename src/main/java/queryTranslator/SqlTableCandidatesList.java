...
public class SqlTableCandidatesList {
	...
	private static Logger LOG = Logger.getLogger(SqlTableCandidatesList.class.getName());
	...
	public SqlTableCandidatesList(String tableName) {
		...
		//REMOVED: AMGAD ! tableName = tableName.replace("http__//yago-knowledge.org/resource/", "");
		...
		//this.placeHolderName = tableName +"$$"+placeHolderId+"$$"; //AMGAD
		this.placeHolderName = tableName;
